...
#include "../Includes/DateTypes.h"
#include "../Includes/BitwiseOperations.h"
#include "../Includes/Timer_Headers/Timer.h"
#include "../Includes/DIO_Headers/DIO.h"
#include "../Includes/Interrupts_Headers/Interrupts.h"

static uint8 TimerPrescalerFlag = 0 ; /* Flag For Timer Prescaler */
...
*
************************************************************************/
void timer0_init(uint8 TimerMode , uint8 TimerPrescaler){
...
void EnableTimer0Interrupt(void){
	...
	Set_Bit(TIMSK_REG,TOIE0_BIT); /* Set TOIE0 Bit in TIMSK Register */
