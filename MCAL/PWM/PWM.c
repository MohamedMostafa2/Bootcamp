...
void PWM1_init(uint8 PWM_OperationMode,uint8 PWM_WaveFormMode,uint8 PWM_Prescaler,uint8 PWM_OutputPin,uint8 PWM_Top){
	...
	ICR1H_REG = PWM_Top; /* ICR1 Register is Top = PWM_Top */
	ICR1L_REG = PWM_Top;
