...
#define PWM1_TOP_MAX    ((uint8)0xFFFF)
#define PWM1_TOP_MIN    ((uint8)0x0003)
...
extern void PWM1_init(uint8 PWM_OperationMode,uint8 PWM_WaveFormMode,uint8 PWM_Prescaler,uint8 PWM_OutputPin,uint16 PWM_Top);

extern void StartPWM1(uint8 PWM_DutyCycle);
